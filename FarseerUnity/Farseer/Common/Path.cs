...
namespace FarseerPhysics.Common
{
    ...
    public class Path
    {
        ...
        {
            for (int i = 0; i < ControlPoints.Count; i++)
				ControlPoints[i] = VectorMath.Multiply(ControlPoints[i], value);
        }
        ...
        public void Rotate(float value)
        {
            ...
            for (int i = 0; i < ControlPoints.Count; i++)
				ControlPoints[i] = VectorMath.Transform(ControlPoints[i], rotationMatrix);
        }
        ...
        public Vector2 GetPosition(float time)
        {
            ...
            if (Closed)
            {
                ...
                temp = VectorMath.CatmullRom(ControlPoints[p0], ControlPoints[p1], ControlPoints[p2], ControlPoints[p3], lt);
        ...
        public Vector2 GetPositionNormal(float time)
        {
			...
			VectorMath.Subtract(ref a, ref b, out temp);
...
output = new Vector2();
			...
			VectorMath.Normalize(ref output, out output);
